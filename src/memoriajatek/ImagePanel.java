...
public class ImagePanel extends JPanel {
  ...
  // Megjeleníti a képet, eredeti méretben, pozicionálás nélkül (null Layout esetén)
  ...
  // Megjeleníti a képet, eredeti méretben, az x,y pozícióban (null Layout esetén)
  ...
  // Megjeleníti a képet, a megadott pozícióban és méretben (null Layout esetén)
